 ...
 */
export function render_rustviz_source_wasm(source_rs: string): any;

/**
 * Run the full RustViz pipeline in the browser. Returns a JS object `{ vis_code, vis_timeline }` (SVG strings).
 */
export function render_rustviz_wasm(main_rs: string, annotated_source_rs: string, source_rs: string): any;
